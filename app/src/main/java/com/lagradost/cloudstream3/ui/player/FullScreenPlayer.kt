...
private fun handleKeyDownEvent(keyCode: Int): Boolean? {
    ...
    when (keyCode) {
        ...
        KeyEvent.KEYCODE_DPAD_DOWN -> {
            // Bölüm listesi (overlay), diyaloglar veya arayüz açıkken tuşları serbest bırak (return null)
            // Böylece focus liste elemanları arasında sorunsuzca gezinebilir.
            if (isShowing || isDialogOpen() || isShowingEpisodeOverlay) {
                return null
            }
        ...
        KeyEvent.KEYCODE_SETTINGS -> {
            ...
            // Bölüm listesi açıksa kapat, kapatsa aç
